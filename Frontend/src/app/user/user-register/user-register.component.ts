...
import { UserServiceService } from 'src/app/sevices/user-service.service';
...
createRegistrationForm(){
  ...
  onSubmit() {
    ...
    if(this.registrationForm.valid)
    {
      ...
      this.alertify.success("Congrats, you arte sucessfully register");
    }else{
      this.alertify.error("Please provide required feilds");
    }
  }
